...
<!-- 
 ...
 -->
  ...
  <article class="filterDiv art tag2">
    ...
    <p> 
      Lionel Bovier, commissaire d'exposition indépendant du MAMCO (&#8239le musée d'art contemporain&#8239) de Genève parle du choix d'intégrer une direction artistique au livre d'art. Comment restituer une exposition dans une édition qui fait sens&#8239? Comment le designer s'empare du rôle d'auteur&#8239?
    </p>
  ...
  <article class="filterDiv art designers">
    ...
    <p> 
      D'après Jean-François Lyotard, Le graphisme est un «&#8239art de rue&#8239», un «&#8239art éphémère&#8239», conçu pour des évènements compris dans un temps limité. Le graphiste est concepteur d'«&#8239art rapide&#8239» et se doit d'intriguer le passant pour l'informer. Il doit donc se démarquer esthétiquement tout en respectant l'objet du commanditaire pour qu'on puisse s'arrêter pour le regarder. Cependant, il n'est pas destiné à être exposé, selon l'auteur, puisque d'une part, il ne saura pas satisfaire la sensibilité du nouveau spectateur, «&#8239cette bête obscure&#8239» et perdra tout sens placé hors de son contexte temporel et géographique. Coincé entre le rôle d'artiste et d'interprête, comment le designer parvient-il à s'émanciper&#8239? 
    </p>
  ...
  <article class="filterDiv edition exposition">
    <h3>
      DUPEYRAT, Jérôme.  
    </h3>
    ...
    <h5>
      Revue Faire, n°11, 25 avril 2018.
    </h5>
